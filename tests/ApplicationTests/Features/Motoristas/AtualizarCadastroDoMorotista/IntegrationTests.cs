    ...
    public class IntegrationTests
    {
        ...
        public async Task UpdateDriverInfos_Successfull()
        {
            using (var runner = MongoDbRunner.Start())
            {
                ...
                collection.InsertOne(new Motorista { Id = "507f191e810c19729de860ea", Cpf = "123.456.789-00", Idade = 20, Nome = "Firstname Lastname", PossuiVeiculoProprio = true, Sexo = Sexo.Feminino, TipoCnh = TipoCnh.A });
                collection.InsertOne(new Motorista { Id = "40af192e110d19029d986dea", Cpf = "987.654.321-00", Idade = 25, Nome = "Firstname Middlename Lastname", PossuiVeiculoProprio = true, Sexo = Sexo.Masculino, TipoCnh = TipoCnh.D });

                var command = new Command { MotoristaId = "507f191e810c19729de860ea", Idade = 20, Nome = "New name", Sexo = Sexo.Feminino, PossuiVeiculoProprio = false, TipoCnh = TipoCnh.B };
        ...
        public async Task UpdateInexistingDriver_OperationCancelled()
        {
            using (var runner = MongoDbRunner.Start())
            {
                ...
                var command = new Command { MotoristaId = "0123456789abcdef01234567", Idade = 20, Nome = "New name", Sexo = Sexo.Feminino, PossuiVeiculoProprio = true, TipoCnh = TipoCnh.B };
                var handler = new CommandHandler(database);
